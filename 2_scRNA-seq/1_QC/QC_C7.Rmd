...
```{r FilterTotalCounts}
filter_by_total_counts <- (umi2$total > 4000)
...
filter_by_expr_features <- (umi2$detected > 1000)
...
```{r FilterParameters}
param <- list()
param$total_counts <- 4000
param$expr_features <- 1000
param$MT <- 10
write.table(param, "path/to/001_filter_param_C7.txt", quote = F)
```
